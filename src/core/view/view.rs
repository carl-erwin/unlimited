...
pub struct View<'a> {
    ...
    */
    ...
    //
    pub compose_content_filters: RefCell<Vec<Box<dyn layout::ContentFilter<'a>>>>,
    pub compose_screen_overlay_filters: RefCell<Vec<Box<dyn layout::ScreenOverlayFilter<'a>>>>,
    pub compose_priority: usize,

    pub filter_in: RefCell<Vec<FilterIo>>,
    pub filter_out: RefCell<Vec<FilterIo>>,
}
...
impl<'a> View<'a> {
    ...
    pub fn new(
        ...
        let mut v = View {
            ...
            compose_content_filters: RefCell::new(vec![]),
            compose_screen_overlay_filters: RefCell::new(vec![]),

            compose_priority: 0, //  greater first
            filter_in: RefCell::new(vec![]),
            filter_out: RefCell::new(vec![]),
        };
