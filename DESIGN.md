...
- Editor organization
  ...
  The editor will be split in two parts:<br/>
     ...
     2. The ui : another process/thread that presents the documents to the user<br/>
     <br/>
     These two threads comunicate using 2 pairs of standard mpsc (sender/receivers) endpoints.<br/>
     <br/>
     ui (TX/RX)<br/>
     core (TX/RX)<br/>
     <br/>
